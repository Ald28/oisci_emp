...
class LocalServiceDataSource {
  ...
  Future<InspectionDetailModel> createInspectionDetail({
    ...
    await db.insert('inspeccion_detalle', {
      ...
      'acceso': inspectionData['acceso'] as String?,
      'fijacion': inspectionData['fijacion'] as String?,
      'uso': inspectionData['uso'] as String?,
      'clase': inspectionData['clase'] as String?,
      'recarga': inspectionData['recarga'] as String?,
      'hidrostatica': inspectionData['hidrostatica'] as String?,
      'presion': inspectionData['presion'] as String?,
      'precinto': inspectionData['precinto'] as String?,
      'cilindro': inspectionData['cilindro'] as String?,
      'carga': inspectionData['carga'] as String?,
      'soporte': inspectionData['soporte'] as String?,
      'manija': inspectionData['manija'] as String?,
      'manguera': inspectionData['manguera'] as String?,
      'tobera': inspectionData['tobera'] as String?,
